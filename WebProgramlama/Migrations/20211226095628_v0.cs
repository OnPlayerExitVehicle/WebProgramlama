    ...
    public partial class v0 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DestinasyonId = table.Column<int>(type: "integer", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Destinasyonlar", x => x.DestinasyonId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    kalkisId = table.Column<int>(type: "integer", nullable: false),
                    inisId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ucuslar", x => x.UcusId);
                    table.ForeignKey(
                        name: "FK_Ucuslar_Destinasyonlar_inisId",
                        column: x => x.inisId,
                        principalTable: "Destinasyonlar",
                        principalColumn: "DestinasyonId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ucuslar_Destinasyonlar_kalkisId",
                        column: x => x.kalkisId,
                        principalTable: "Destinasyonlar",
                        principalColumn: "DestinasyonId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BiletId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AlimTarihi = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UcusId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
